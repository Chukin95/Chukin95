...
document.getElementById("txtImagen_url").value = decodeURI(parts[2][1]) // muestra la imagen url decodificada en el campo de texto
document.getElementById("txtPrecio").value = parts[3][1] // muestra el precio en el campo de texto
document.getElementById("txtcantidad").value = parts[4][1] // muestra el cantidad en el campo de texto
